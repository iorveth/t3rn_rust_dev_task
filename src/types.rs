...
pub enum ExecutionType<AccountId> {
	Swap { caller: AccountId, to: AccountId, amount_from: Amount, amount_to: Amount, asset: Asset },
	Tran { caller: AccountId, to: AccountId, amount: Amount },
	MultiTran { caller: AccountId, to: AccountId, amount: Amount, asset: Asset },
}
...
pub enum SideEffectTypeRecord<AccountId> {
	SingleChain { chain: Chain, side_effect: SideEffect<AccountId> },
	MultiChain { chain_from: Chain, chain_to: Chain, side_effect: SideEffect<AccountId> },
}
